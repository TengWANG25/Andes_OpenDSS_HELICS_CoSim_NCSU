...
def save_results_to_csv(df: pd.DataFrame, out_csv: str):
    ...
    # Drop original complex columns to avoid confusion in CSV (we have the _re, _im, and _str versions now)
...
if __name__ == "__main__":
    # Example usage
    path = "gpk_118_10_bus_conn.csv"   # Path to the log file generated by the co-simulation
    bus_id = 2
    baseMVA = 100.0

    # Output CSV will be saved in the same directory as this script with a name like "parsed_bus2_metrics.csv"
